...
class _QuizScoreState extends State<QuizScore> {
  ...
  Widget build(BuildContext context) {
    int _unattempted=widget.numOfQuestions-(int.parse(widget.correctAnswers)+int.parse(widget.incorrectAnswers));
              ...
              Container(
                ...
                child: StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return SingleChildScrollView(child: (Column(children: questionsWidgets)));
                  },
                ),
              )
            ],
